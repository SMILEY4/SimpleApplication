 ...
 */
@Slf4j
public class MultiObjectJsonRepositoryImpl implements MultiObjectJsonRepository {
	 ...
	 */
	public MultiObjectJsonRepositoryImpl(final Resource directory) {
	 ...
	 * @param directory the root directory of the repository.
	 */
	public MultiObjectJsonRepositoryImpl(final String directory) {
