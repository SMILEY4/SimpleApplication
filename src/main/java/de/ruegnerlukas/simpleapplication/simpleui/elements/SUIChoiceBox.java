...
public final class SUIChoiceBox {
	...
	private static class ChoiceBoxNodeBuilder implements BaseFxNodeBuilder<ChoiceBox<Object>> {


		@Override
		public ChoiceBox<Object> build(final MasterNodeHandlers nodeHandlers, final SUINode node) {
