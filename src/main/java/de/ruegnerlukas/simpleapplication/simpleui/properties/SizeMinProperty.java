...
public class SizeMinProperty extends Property {
	...
	public static class SizeMinUpdatingBuilder implements PropFxNodeUpdatingBuilder<SizeMinProperty, Region> {
		...
		@Override
		public void build(final SceneContext context, final SNode node, final SizeMinProperty property,
						  final Region fxNode) {
		...
		@Override
		public MutationResult update(final SceneContext context, final SizeMinProperty property,
		...
		@Override
		public MutationResult remove(final SceneContext context, final SizeMinProperty property,
									 final SNode node, final Region fxNode) {
