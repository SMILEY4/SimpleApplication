...
public class OnMouseDragExitedEventProperty extends AbstractEventListenerProperty<MouseDragEventData> {
	...
	public static class UpdatingBuilder implements PropFxNodeUpdatingBuilder<OnMouseDragExitedEventProperty, Node> {
		...
		@Override
		public void build(final MasterNodeHandlers nodeHandlers, final SUINode node, final OnMouseDragExitedEventProperty property,
						  final Node fxNode) {
		...
		@Override
		public MutationResult update(final MasterNodeHandlers nodeHandlers, final OnMouseDragExitedEventProperty property,
		...
		@Override
		public MutationResult remove(final MasterNodeHandlers nodeHandlers, final OnMouseDragExitedEventProperty property,
									 final SUINode node, final Node fxNode) {
