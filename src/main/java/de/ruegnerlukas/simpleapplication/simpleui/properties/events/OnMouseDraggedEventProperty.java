...
public class OnMouseDraggedEventProperty extends AbstractEventListenerProperty<MouseDragEventData> {
	 ...
	 */
	public static final String EVENT_ID = "mouse.drag.dragged";
	...
	public static class UpdatingBuilder implements PropFxNodeUpdatingBuilder<OnMouseDraggedEventProperty, Node> {
		...
		@Override
		public void build(final MasterNodeHandlers nodeHandlers, final SuiNode node, final OnMouseDraggedEventProperty property,
						  final Node fxNode) {
		...
		@Override
		public MutationResult update(final MasterNodeHandlers nodeHandlers, final OnMouseDraggedEventProperty property,
		...
		@Override
		public MutationResult remove(final MasterNodeHandlers nodeHandlers, final OnMouseDraggedEventProperty property,
									 final SuiNode node, final Node fxNode) {
		...
		private void setListener(final Node fxNode, final OnMouseDraggedEventProperty property) {
			fxNode.setOnMouseDragged(e -> property.getListener().onEvent(new SuiEvent<>(
					EVENT_ID,
