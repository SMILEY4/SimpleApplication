...
@AllArgsConstructor
@ToString
public class MouseDragEventData {


	/**
	 * The x position of the drag. The origin (0,0) is in the top left.
	 */
	private final double x;

	/**
	 * The y position of the drag. The origin (0,0) is in the top left.
	 */
